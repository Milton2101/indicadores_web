...
if resultado is not None:
    ...
    print("\nCantidad de despachos programados:")
    print(resultado["diario"]["despachos_programados"].sum())
    print("\nCantidad de despachos efectuados:")
    print(resultado["diario"]["despachos_efectuados"].sum())
    print("\nCumplimiento de servicio:")
    print(f"{resultado['diario']['despachos_efectuados'].sum() / resultado['diario']['despachos_programados'].sum()*100:.2f}%")